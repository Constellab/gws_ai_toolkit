...
class DataFrameItem:
    ...
    def _handle_merged_cells(self, file_path: str, sheet_name: str = None) -> DataFrame:
        ...
        try:
            ...
            print(f"Error handling merged cells in '{file_path}': {e}")
            # Fall back to normal pandas reading
            if sheet_name:
    ...
    def get_dataframe(self, sheet_name: str = "") -> DataFrame:
        ...
        try:
            ...
            print(f"Error loading dataframe from '{self.file_path}' sheet '{sheet_name}': {e}")
            return DataFrame()
