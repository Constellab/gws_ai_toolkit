...
class RagChatEndStreamResponse(BaseModelDTO):
    ...
    def add_source(self, document_id: str, document_name: str,
                   chunk_id: str, chunk_score: float, chunk_content: Optional[str]) -> None:
        ...
        chat_source.add_chunk(RagChatSourceChunk(
            chunk_id=chunk_id,
