...
@task_decorator(
    ...
    human_name="Send files to Dify Knowledge Base",
    ...
    config_specs = ConfigSpecs(
        {
            ...
            "dataset_id": StrParam(
                human_name="Dify knowledge base id",
                short_description="Id of the Dify knowledge base where to send the files",
            ),
            "indexing_technique": StrParam(
                human_name="Indexing technique",
            ...
            "chunk_separator": StrParam(
                human_name="Chunk separator",
                short_description="Separator to use to split the text into chunks",
                default_value="\\n\\n",
            ),
            "chunk_max_tokens": IntParam(
                human_name="Chunk max tokens",
        ...
        for file_path in file_paths:
            try:
                ...
                self.log_error_message(
                    f"Error while sending file '{file_path}' to Dify Knowledge Base: {str(e)}"
                )
