...
def _show_additional_test_suggestion() -> rx.Component:
    ...
    return rx.cond(
        ...
        rx.box(
            rx.heading(
                "Suggested Additional Test", size="3", margin_bottom="0.5em", margin_top="1em"
            ),
            rx.box(
                rx.text(
                ...
                rx.form(
                    rx.vstack(
                        rx.cond(
                            ...
                            rx.text(
                                "Reference group (Optional):", font_weight="bold", font_size="0.9em"
                            ),
                            rx.text(
        ...
        rx.box(
            ...
            rx.vstack(
                rx.hstack(
                    ...
                    rx.text(AiTableStatsState.last_run_config.str_columns, font_size="0.9em"),
                    spacing="2",
                ),
                rx.hstack(
